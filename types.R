...
m <- matrix(runif(9,0,10), nrow = 3, ncol = 3) #random 9 numbers between 0-10
m

m <- array(runif(27,0,10), c(3,3,3)) #3x3x3 array
m
...
y   <- c("23.8", "6", "100.01","6")
y.c <- as.numeric(y) # change character to numeric
y.c

as.integer(y) # change numeric to integer
